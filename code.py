...
def buyFood(food):
    if food == 'rice':
        ...
        time.sleep(.2)
        s = screenGrab()
        print s.getpixel(Cord.ricecol)
        if s.getpixel(Cord.ricecol) != (118, 83, 85):
    ...
    if food == 'nori':
        ...
        time.sleep(.2)
        s = screenGrab()
        print s.getpixel(Cord.t_noricol)
        if s.getpixel(Cord.t_noricol) != (109, 123, 127):
    ...
    if food == 'roe':
        ...
        time.sleep(.2)
        s = screenGrab()
        print s.getpixel(Cord.t_roecol)
        if s.getpixel(Cord.t_roecol) != (109, 123, 127):
...
def main():
    ...
    get_cords()
    im = screenGrab()
    print im.getpixel(Cord.ricecol)
    """
